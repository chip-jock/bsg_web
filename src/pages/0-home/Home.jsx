...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 text-gray-100 font-roboto font-light flex flex-row bg-opacity-50 tracking-tight pt-24">
        <div className="md:w-1/4"></div>
        <div className="md:w-1/2 md:h-1/2">
          <p className="text-xl md:text-2xl text-gray-700 text-justify bg-gray-100 bg-opacity-90 p-8 mx-16 mt-32 md:mt-12 lg:mt-24 rounded-md">
