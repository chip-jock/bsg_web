      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="text-lg md:text-xl p-6 md:p-10 bg-white rounded-lg shadow-xl mb-10">
          ...
          <p className="font-roboto">
            ...
            sustainability in waste management and resource recovery.
            With five US patents granted and multiple patents pending
            or in development, we are at the forefront of
        ...
        <div className="p-6 md:p-10 bg-white rounded-lg shadow-xl mb-10">
          ...
          <div className="text-lg md:text-xl space-y-6 text-gray-800 font-roboto">
            <p>
              ...
              LLC and Landaira Inc. enable the broader application of
              our innovations.
            </p>
          </div>
        </div>
