    ...
    <div className="relative flex flex-col justify-center items-center min-h-screen py-32 px-4 md:px-8 lg:px-16 bg-gray-100 text-gray-900">
      <div className="w-full max-w-6xl">
        ...
        <div className="p-6 md:p-10 bg-white rounded-lg shadow-xl mb-10">
          ...
          <div className="text-lg md:text-xl space-y-6 text-gray-800 font-roboto">
            <p>
              ...
              US Patent 11,325,834 B2 - This innovation in engineered
              carbon laid the foundation for our future developments.
            </p>
            <p>
              <span className="font-semibold">
              ...
              waste through chemical and thermal methods, with patents
              pending in multiple countries.
            </p>
            <p>
              <span className="font-semibold">
        ...
        <div className="p-6 md:p-10 bg-white rounded-lg shadow-xl">
          ...
          <div className="text-lg md:text-xl space-y-6 text-gray-800 font-roboto">
            <p>
              At Bright Sand Canada, our commitment to sustainability,
              innovation, and excellence drives everything we do. We
              strive to lead the industry in waste management and
              resource recovery, creating solutions that contribute to
