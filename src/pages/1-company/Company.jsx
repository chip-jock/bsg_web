        ...
        <div className="w-full max-w-6xl">
          ...
          <div className="flex flex-col">
            <div className="text-lg md:text-xl p-6 md:p-10 bg-white rounded-lg shadow-xl mb-12 flex-1">
              ...
              <p className="text-gray-800 font-roboto">
                Bright Sand transitioned from a humble beginning into
                a beacon of innovation and commitment. In 2014, we
                laid our foundation as a sole proprietorship, a nod to
                our familial roots and a testament to our dedication.
                The ensuing years marked our expansion and
                incorporation, first with Bright Sand Canada in
                Windsor, Ontario, in 2020, and soon after, Bright Sand
                Inc. in Chattanooga, TN. In 2023, we further
                solidified our presence by establishing Bright Sand
                Industries in Detroit, Michigan. Each step on this
                journey was not just a growth in our footprint but a
                reaffirmation of our commitment to making a tangible
                impact.
              </p>
